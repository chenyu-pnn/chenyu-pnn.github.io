...
function GitHubIcon() {
  return (
    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="butt" strokeLinejoin="miter">
      <path d="M15 22v-4a4.8 4.8 0 0 0-1-3.5c3 0 6-2 6-5.5.08-1.25-.27-2.48-1-3.5.28-1.15.28-2.35 0-3.5 0 0-1 0-3 1.5-2.64-.5-5.36-.5-8 0C6 2 5 2 5 2c-.3 1.15-.3 2.35 0 3.5A5.403 5.403 0 0 0 4 9c0 3.5 3 5.5 6 5.5-.39.49-.68 1.05-.85 1.65S9 17.38 9 18v4" />
      ...
      >
        ...
        <div>
          ...
          <div style={{ display: 'flex', gap: '6px', marginBottom: '16px' }}>
            ...
            {links.github   && <IconLink href={links.github}               title="GitHub"               ><GitHubIcon /></IconLink>}
            {links.linkedin && <IconLink href={links.linkedin}             title="LinkedIn"             ><LinkedInIcon /></IconLink>}
            {links.resume   && <IconLink href={links.resume}               title="Resume"   external={false}><ResumeIcon /></IconLink>}
          </div>
